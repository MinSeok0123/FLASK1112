...
@app.route("/")
def home():
    return render_template('index.html', subject="안녕하세요. 반갑습니다. 이민석입니다")
...
@app.route("/about")
def about():
    return render_template('marry.html', subject="혼인 수")
 
#3 이미지1 - 자기가 좋아하는 사람 등등 사진
@app.route("/show1")
def show1():
    return render_template('1.html', image_file='img/1.gif')
 
#3 이미지2 - 크리스마스 카드 for 쌤
@app.route("/show2")
def show2():
    return render_template('2.html', image_file='img/2.gif')
